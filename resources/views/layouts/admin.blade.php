...
<body class="bg-gray-100">
    <div class="flex h-screen">
        <!-- Sidebar -->
        <aside class="w-64 bg-[#004a73] text-white flex-shrink-0 overflow-y-auto">
            <div class="p-6">
            ...
            <nav class="mt-6">
                ...
                <!-- Verifikasi UBSC -->
                <a href="#" 
                   class="flex items-center px-6 py-3 hover:bg-[#003d5e] transition">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="absolute bottom-0 w-64 p-6">
                <a href="/" class="flex items-center text-white hover:text-red-300 transition w-full">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <header class="bg-white shadow-md">
                <div class="flex items-center justify-between px-8 py-4">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-gray-600">Admin: <span class="font-semibold text-[#004a73]">Administrator</span></span>
